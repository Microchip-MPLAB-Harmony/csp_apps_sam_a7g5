...
This example shows how to use the QSPI Peripheral library to perform erase, write and read operation with the Octal SPI Flash memory in SPI mode.
...
5. The LED indicates the success or failure:
    - The LED is turned ON when the value read from the Octal SPI Flash memory matched with the written value
